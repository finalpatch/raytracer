...
{
public:
	Sphere(const Vec3<T> &c, const T &r, const Vec3<T> &clr, const T& refl = 0.0, const T& trans = 0.0)
		: m_center(c), m_radius(r), m_color(clr), m_reflection(refl), m_transparency(trans)
	{}
